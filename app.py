...
CURRENT_WEEK = "4주차"           # 해당 주차
ADMIN_PASSWORD = "3383"          # 선생님용 비밀번호

# 퀴즈 데이터 (수동으로 제공해주신 7문항 반영)
QUIZ_DATA = [
    {"q": "1. 이슈2의 입장A에서 작은 돈부터 아껴 목돈을 만드는 습관의 중요성을 강조하며 언급한 용어는 무엇인가?", "a": "라떼 효과"},
    {"q": "2. 돈을 벌고, 쓰고, 저축하고, 투자하고, 빌리는 개인의 재무적 행동능력과 태도, 가치를 의식적 또는 무의식적으로 배우는 과정은 무엇인가?", "a": "금융사회화"},
    {"q": "3. 돈과 관련된 부부 갈등의 발생 원인은 소득 감소, (_______________), 소비 습관의 차이 등이다.", "a": "재무적 부정직"},
    {"q": "4. 남과의 비교는 상대적 (____________)을 초래해 사람을 불행하게 만든다.", "a": "박탈감"},
    {"q": "5. 어느 조직에서 목표가 구체적일 때, 다소 어렵더라도 달성가능할 때, 마감시한이 있을 때 가장 좋은 성과가 난다고 설명하는 이론은?", "a": "목표설정이론"},
    {"q": "6. “자녀교육과 재산형성이 주요 재무이슈인 생애주기는?", "a": "자녀 성장기"},
    {"q": "7. 나와 가족의 인생에서 목돈이 필요한 중요 이벤트가 몇 살에 생길지를 미리 예상해 보기 위한 표는?", "a": "생애설계연표"}
]
