...
CURRENT_WEEK = "9주차"            # 해당 주차
ADMIN_PASSWORD = "3383"          # 선생님용 비밀번호

# 퀴즈 데이터 (수동으로 제공해주신 7문항 반영)
QUIZ_DATA = [
    {"q": "1. 3M 모델은 미래 지향적 행동을 이해하는 데 유용하여 (_________) 재무 계획이나 저축 행태 연구에 적합하다.", "a": "은퇴"},
    {"q": "2. MBTI에서 사고형(T)은 의사결정을 내릴 때 (___________)이고 이성적이다.", "a": "논리적"},
    {"q": "3. MBTI와 투자 행태 연구에서 상반된 결과가 나오는 이유는, 연구 샘플의 (____________) 차이 때문으로 해석된다.", "a": "문화적"},
    {"q": "4. Gakhar and Prakash (2017)에 따르면, 감정(F) 유형일수록 본인의 판단을 지나치게 믿는 과잉 확신 편향이 (__________) 나타난다. (많게/적게 중에서 하나를 적으세요)", "a": "적게"},
    {"q": "5. MBTI가 투자성향을 ‘결정’하는 검사라는 주장은 (_____________). (적절하다/적절하지 않다 중에서 하나를 적으세요)", "a": "적절하지 않다"},
    {"q": "6. BIT(Behavioral Investor Types) 모델에서 트렌드는 놓칠 수 없지! 친절한 유행 선도자에 해당하는 유형은? (한글만 적으세요)", "a": "추종자"},
    {"q": "7. 자기 자신을 타인과 관계된 존재로 여기는 것은 (______________) 자아해석이라 한다.", "a": "상호의존적"}
]
