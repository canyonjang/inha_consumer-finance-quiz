...
# ---------------------------------------------------------
QUIZ_DATA = [
    {"q": "1. 이게 비싼 건 알지만, 나보다 더 비싸게 사줄 더 큰 (______)가 있을 거야라는 맹신이 시장에 거품(Bubble)을 만든다.", "a": "바보"},
    {"q": "2. 이익이 난 주식은 너무 일찍 팔아버리고, 손실이 난 주식은 고통을 피하려 방치하는 것은 (_____)효과로 설명된다.", "a": "처분"},
    {"q": "3. 투자설계란, 투자목표와 투자(_____)을 파악하여 투자자의 위험수준에 적정한 투자전략을 수립, 실행하고 이를 모니터링하는 과정임", "a": "기간"},
    {"q": "4. 투자는 투자를 실행하기 전부터 투자기간이 종료될 때까지 지속적으로 (_______)과 노력을 투입하여 투자상품을 관리해야 함", "a": "시간"},
    {"q": "5. 변동성을 위험지표로 사용할 때의 단점은 손실뿐만 아니라 (______)이 발생한 경우에도 위험으로 인식한다는 점임", "a": "수익"},
    {"q": "6. 표준편차는 평균으로부터 데이터가 얼마나 퍼져 있는지를 나타내는 대표적인 통계 지표임. 보통 변동성은 (________)의 표준편차임", "a": "수익률"},
    {"q": "7. 변동성은 수익의 (______)을 말하는 것이 아님", "a": "방향"},
]
