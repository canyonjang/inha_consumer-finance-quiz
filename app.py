...
QUIZ_DATA = [
    {"q": "1. 경제적 복지의 4가지 유형 중에서, 객관적 조건은 좋은데, 주관적 평가가 불만족인 유형은?", "a": "주관적 불만형"},
    {"q": "2. 생애재무설계는 나와 우리 가족의 재무목표를 구체적으로 정한 뒤 그 목표를 달성하기 위해 계획을 세우고 실행하는 것이다. 생애재무설계는 (___________) 정리하기로 시작한다.", "a": "재무목표"},
    {"q": "3. “저 사람(판매자)이 왜 저런 제안을 할까? 나에게 도움이 될까?”라는 의문을 풀기 위한 소비자들이 축적한 경험과 노하우는 무엇인가?", "a": "설득지식"},
