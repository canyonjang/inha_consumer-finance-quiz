...
CURRENT_WEEK = "4주차"                  # 매주 여기만 바꾸면 됩니다
...
# ---------------------------------------------------------
QUIZ_DATA = [
    {"q": "1. 전망이론에 따르면, 이익과 손실 사이에 비대칭성이 존재한다. 손실의 (_________)이 이익의 즐거움 보다 2배 이상 크다.", "a": "괴로움"},
    {"q": "2. 가치함수의 이익 국면에서는 위험회피적이고, 손실 국면에서는 위험(_______)적이다.", "a": "추구"},
    {"q": "3. Walasek 외(2024)는 (___________)가 견고하고 보편적이라는 통념에 의문을 제기하였다.", "a": "손실회피"},
    {"q": "4. 행동경제학에 의하면 개인은 다양한 투자목표를 설정하여 개별 투자 목표를 달성하기 위해 (______)를 분리하여 관리하는 경향이 있다.", "a": "계좌"},
    {"q": "5. 투자기간이 짧은 경우 (______)과 같이 단기간에 급등락을 반복하는 금융 상품에 투자하는 것은 매우 위험하다.", "a": "주식"},
    {"q": "6. 정부는 조세 목적을 달성하기 위해 금융상품 가입자에게 금융소득에 대한 세금을 비과세하거나 분리과세로 과세를 종료하거나 (______)공제 또는 세액공제 등의 형태로 다양한 세제혜택을 제공하고 있다.", "a": "소득"},
    {"q": "7. 증권은 발생한 손실이 투자 원금 이하인 금융투자상품이고, (__________)은 손실이 원금을 초과할 가능성이 있는 금융투자상품이다.", "a": "파생상품"},
]
