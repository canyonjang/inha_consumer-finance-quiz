...
QUIZ_DATA = [
    ...
    {"q": "4. 계획된 행동이론에서 행위의도는 행동에 대한 태도, 주관적 규범, 지각된 (___________) 등에 영향을 받는다.", "a": "통제감"},
    {"q": "5. 계획된 행동이론에 대한 가장 대표적인 비판은 의도-행동 간극이며, 이를 해결하기 위해 (___________)를 추가하였다.", "a": "실행 의도"},
    {"q": "6. “저 사람(판매자)이 왜 저런 제안을 할까? 나에게 도움이 될까?”라는 의문을 풀기 위한 소비자들이 축적한 경험과 노하우는 무엇인가?", "a": "설득지식"},
