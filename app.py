...
QUIZ_DATA = [
    {"q": "1. 부자는 “돈은 늘 안전하게 관리하고 리스크는 피하는 게 상책이다”라고 생각한다. (맞음 또는 틀림)", "a": "틀림"},
    {"q": "2. 부자 아빠는 다음 내용을 가리켜 무엇이라고 불렀나? 아침에 일어나서 직장에 출근하고 청구서를 내고, 또 일어나서 직장에 가고 청구서를 내는 패턴이지. 더 많은 돈을 벌면 지출을 늘려서 그 패턴을 반복하지.", "a": "새앙쥐 레이스"},
    {"q": "3. 부자 아빠는 “(_______)과 부채의 차이를 알고 (_______)을 사라. 수입을 창출하는 (________)을 사는 데 전념하라.”라고 가르쳤다. (________)에 들어갈 공통적인 단어는 무엇인가?", "a": "자산"},
    {"q": "4. 부자 아빠는 “가난한 이들이나 중산층이 하는 것처럼 몇 개 안 되는 달걀을 여러 바구니에 나눠 담지 마라”라고 가르쳤다. (맞음 또는 틀림)", "a": "맞음"},
    {"q": "5. 부자 아빠는 수입을 근로 소득, (__________), 비활성 소득 등 3가지로 구분했다.", "a": "투자 소득"},
    {"q": "6. 돈의 심리학 저자는 “저축이란 당신의 (___________)과 소득 사이에 생긴 틈이다”라고 주장한다.", "a": "자존심"},
    {"q": "7. 돈의 심리학 저자는 “투자에서 가장 강력한 힘을 가진 것은 (_________)이다”라고 강조한다.", "a": "시간"}
]
